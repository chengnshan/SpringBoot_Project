package com.cxp.springboot2rabbitmqxml.rabbitProducer;

import com.cxp.springboot2rabbitmqxml.pojo.UserInfo;
import com.cxp.springboot2rabbitmqxml.utils.JackJsonUtil;
...
public class DirectProducer {
    ...
    public void directSend(){
        ...
        System.out.println("DirectProducer : " + receive);
    }
    ...
    public void directSendList(){
        ...
        LOGGER.info("DirectProducer : " + receive);
    }
