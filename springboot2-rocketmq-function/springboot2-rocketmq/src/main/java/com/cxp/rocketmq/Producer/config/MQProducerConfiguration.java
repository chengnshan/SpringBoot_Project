...
public class MQProducerConfiguration {
    ...
    public DefaultMQProducer getRocketMQProducer() throws MQClientException {
        if (StringUtils.isEmpty(this.groupName)) {
            throw new MQClientException(405, "groupName is blank");
        }
        if (StringUtils.isEmpty(this.namesrvAddr)) {
            throw new MQClientException(405, "nameServerAddr is blank");
        }
        ...
        try {
            ...
            throw new MQClientException("start MQClientException", e);
        }
        return producer;
    }
}
