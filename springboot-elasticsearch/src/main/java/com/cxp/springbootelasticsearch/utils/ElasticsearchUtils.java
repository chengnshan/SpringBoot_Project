package com.cxp.springbootelasticsearch.utils;
...
public class ElasticsearchUtils {
    ...
    @PostConstruct
    public void ElasticsearchUtils(){
        ElasticsearchUtils.client = elasticsearchClient;
    }
    /**
     * 创建索引
     *
     ...
     * @return
     */
    public static boolean isIndexExist(String index,TransportClient tClient) {
        IndicesExistsResponse inExistsResponse = tClient.admin().indices().exists(new IndicesExistsRequest(index)).actionGet();
        if (inExistsResponse.isExists()) {
            LOGGER.info("Index [" + index + "] is exist!");
        } else {
            LOGGER.info("Index [" + index + "] is not exist!");
