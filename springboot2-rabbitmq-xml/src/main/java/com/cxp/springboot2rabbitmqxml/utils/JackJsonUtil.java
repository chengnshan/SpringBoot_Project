package com.cxp.springboot2rabbitmqxml.utils;
...
public class JackJsonUtil {
	...
	public static String objTojson(Object obj) {
		try{
			...
			logger.error("objTojson exception: "+e.getMessage(),e);
		}
		return null;
	}
	...
	public static void main(String[] args) {
		...
		Map map1 = JackJsonUtil.jsonToObject(strMap, Map.class);
		System.out.println(map1.get("userInfo1"));
	}
}
